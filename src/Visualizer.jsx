            ...
            <>
                <nav className="navbar navbar-expand-lg navbar-light fixed-top bg-dark">
                    ...
                    <div className={"dropdown" + invisibleOrNot}>
                        <button className="btn btn-secondary dropdown-toggle navbtn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" disabled={this.state.rendering}>
                            {this.state.currentAlgorithm == null ? 'Algorithms' : this.state.currentAlgorithm}
                        </button>
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                                {algorithms.map((algorithm, algoId) => {
                                    return (<button type="button"  className="btn btn-light navbtn" onClick={() => {
                    ...
                    <div className={"dropdown" + invisibleOrNot}>
                        <button className="btn btn-light dropdown-toggle navbtn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" disabled={this.state.rendering}>
                            Actions
                        </button>
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                                <button type="button" className="btn btn-light navbtn" onClick={() => this.state.goFunction()} data-toggle={this.state.currentAlgorithm === null ? "modal" : ""} data-target="#setAlgoModal" disabled={this.state.mode === "ai" && this.state.currentAlgorithm === "Minimax"}>Go!</button>
                                <button type="button" className="btn btn-light navbtn" onClick={() => this.state.resetFunction()}>Reset</button>
                            </li>
                        </div>
                    </div>

                    <a href="https://github.com/JasonFengGit" style={{ marginLeft: "32%" }}>
                        <img className="githubimg" src="https://github.com/JasonFengGit/Visualizer/raw/master/src/Github_icon.png" width="40px" height="40px" style={{ opacity: "0.7 !important"}} alt="image"></img>
                    </a>
                </nav>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-dark" data-dismiss="modal" style={{ width: '100px' }}>OK</button>
                            </div>
                        </div>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content intro">
                            ...
                            <div className="modal-body intro">
                                ...
                                <span>Pathfinding is also similar to Searching in some circumstances. For instance, we can use [breadth-first search] to find the shortest path in a grid world.</span>
                                <span>
                                ...
                                <span>You may drag the START and TARGET icons to change their positions, and click on the blank nodes to add Walls.</span>

                                <span>Now please choose a sorting algorithm and visualize it!</span>
                                <span className='tips'>(after choosing an algorithm, click on the [Actions] button.)</span><br />
                                <span className='tips'>Note: there could be multiple "best" paths, so paths generated by different algorithms may not be consistent.</span>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-dark" data-dismiss="modal" style={{ width: '100px' }}>OK</button>
                            </div>
                ...
                <div className="modal fade" id="sortingIntroModal" role="dialog">
                    <div className="modal-dialog">
                        <div className="modal-content intro">
                            ...
                            <div className="modal-body intro">
                                <span>Sorting is a process of arranging an ordered sequence. It is a common operation in many applications.</span>
                                <span>Common uses of sorted sequences are:
...
an                                Now please choose a sorting algorithm and visualize it!
                                ...
                                <span className='tips'>(after choosing an algorithm, click on the [Actions] button.)</span>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-dark" data-dismiss="modal" style={{ width: '100px' }}>OK</button>
                            </div>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content intro">
                            ...
                            <div className="modal-body intro">
                                ...
                                <span> Now please choose an algorithm and begin your journey!</span>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-dark" data-dismiss="modal" style={{ width: '100px' }}>OK</button>
                            </div>
